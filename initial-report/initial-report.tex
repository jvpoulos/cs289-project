...
\begin{figure}[htbp] 
   \centering
   \includegraphics[scale=0.7]{pairs-plot-continuous.png} 
   \caption{Pairwise correlations and distributions (diagonal) for all continuous features in Adult dataset. Feature values standardized to midrange 0 and range 2 (i.e., minimum -1 and maximum 1).}
   \label{pairs-plot-continuous}
\end{figure}
