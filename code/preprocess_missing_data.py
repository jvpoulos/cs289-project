...
(np.eye(2)[labels.astype(int)]).astype(int).dump('../adult-dataset/labels_onehot.np')
...
(np.eye(2)[labels[full_obs].astype(int)]).astype(int).dump('../adult-dataset/labels_drop_bin_onehot.np')
...
np.savetxt("../adult-dataset/data_drop.csv", data_drop, delimiter=",", fmt="%s")
...
np.savetxt("../adult-dataset/data_mode.csv", data_mode, delimiter=",", fmt="%s")
...
np.savetxt("../adult-dataset/data_predicted.csv", data_predicted, delimiter=",", fmt="%s")
