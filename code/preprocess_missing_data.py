...
data_drop_bin.dump('data_drop_bin.np')
labels[full_obs].dump('labels_drop_bin.np')
...
data_replace_bin.dump('data_replace_bin.np')
...
data_predicted_bin.dump('data_predicted_bin.np')
...
data_facanal_bin.dump('data_facanal_bin.np')
...
data_knn_bin.dump('data_knn_bin.np')