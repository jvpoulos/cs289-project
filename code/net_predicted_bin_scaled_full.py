...
x_train = np.load('../adult-dataset/data_predicted_bin_scaled.np')
y_train = np.load('../adult-dataset/labels_onehot.np')
x_test = np.load('../adult-dataset/data_test_predicted_bin_scaled.np')
...
# test error rate with 100 : 0.195381119096
# test error rate with 50 : 0.190590258584
# test error rate with 10 : 0.175971991892
# test error rate with 5 epoch 0.169891284319
# test error rate with 1 epoch 0.166390270868
