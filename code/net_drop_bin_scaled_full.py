...
x_test = np.load('../adult-dataset/data_test_drop_bin_scaled.np')
y_test = np.load('../adult-dataset/labels_test_drop_bin_onehot.np')
...
# test error rate with 1000 epochs 0.220185922975
# test error rate with 500 epochs 0.220717131474
# test error rate with 100 epochs 0.204581673307
# test error rate with 50 epochs 0.202589641434
# test error rate with 10 epochs 0.193160690571
# test error rate with 5 epochs 0.189176626826
# test error rate with 1 epoch 0.18598937583
